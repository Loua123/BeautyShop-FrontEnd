...
@Component({
  selector: 'app-demande-vendeurs',
  templateUrl: './demande-vendeurs.component.html',
  styleUrls: ['./demande-vendeurs.component.css']
})
export class DemandeVendeursComponent implements OnInit {
  user:any;
  listofusers:any;
  listofstores:any;
